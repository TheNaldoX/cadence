...
android {
    namespace = "fr.velo.cadence"
    compileSdk = 35

    defaultConfig {
        applicationId = "fr.velo.cadence"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
        ...
        // User-Agent envoye aux serveurs OSM / BRouter : la politique d'usage
        // d'OpenStreetMap exige un identifiant applicatif unique et joignable.
        buildConfigField("String", "HTTP_USER_AGENT", "\"Cadence/1.0 (Android; contact@example.com)\"")
        buildConfigField("String", "BROUTER_BASE_URL", "\"https://brouter.de/brouter\"")
